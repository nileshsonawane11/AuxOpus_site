      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="px-4 py-6 sm:p-6 md:p-8 lg:p-10">
          ...
          <div className="mb-6 sm:mb-8 md:mb-10 border-b border-gray-200 pb-4 sm:pb-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-900 mb-3 sm:mb-4">Privacy Policy</h1>
            <p className="text-center text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4">for AuxOpus LLP</p>
            <div className="flex flex-wrap justify-center sm:justify-between items-center text-xs sm:text-sm text-gray-600 pt-2 border-t border-gray-100 gap-2 sm:gap-0">
          ...
          <div className="space-y-6 sm:space-y-8 md:space-y-10">
            {/* Section 1 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">1. Introduction</h2>
              ...
              <div className="mt-4 p-3 sm:p-4 bg-blue-50 border-l-4 border-blue-600 rounded-r">
            ...
            <section>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-5 sm:mt-6 mb-2 sm:mb-3">2.1 Data You Provide Directly</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-5 sm:mt-6 mb-2 sm:mb-3">2.2 Data Collected Automatically</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-5 sm:mt-6 mb-2 sm:mb-3">2.3 Sensitive Data</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            {/* Section 3 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">3. How We Use Your Personal Data</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">
              ...
              <div className="mt-4 sm:mt-5 p-3 sm:p-4 bg-green-50 border-l-4 border-green-600 rounded-r">
            ...
            {/* Section 4 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">4. Client Data and Project Confidentiality</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-5 sm:mt-6 mb-2 sm:mb-3">4.1 NDA and Confidentiality</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-5 sm:mt-6 mb-2 sm:mb-3">4.2 Source Code and Intellectual Property</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-5 sm:mt-6 mb-2 sm:mb-3">4.3 System Access</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mt-5 sm:mt-6 mb-2 sm:mb-3">4.4 End-User Data</h3>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">5. Legal Basis for Processing</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">Where applicable, we process personal information based on one or more of the following legal grounds:</p>
              <ul className="list-disc pl-5 sm:pl-6 text-sm sm:text-base text-gray-700 space-y-1.5 sm:space-y-2 leading-relaxed">
            ...
            {/* Section 6 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">6. How We Share Your Personal Data</h2>
              <div className="mb-3 sm:mb-4 p-3 sm:p-4 bg-green-50 border-l-4 border-green-600 rounded-r">
                <p className="text-gray-700 leading-relaxed font-medium text-sm sm:text-base">✓ We do not sell your personal information.</p>
              </div>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">We may share information with:</p>
              <ul className="list-disc pl-5 sm:pl-6 text-sm sm:text-base text-gray-700 space-y-1.5 sm:space-y-2 leading-relaxed">
              ...
              <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-gray-50 rounded border border-gray-200">
                <p className="text-gray-700 leading-relaxed text-xs sm:text-sm">
            ...
            {/* Section 7 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">7. International Data Transfers</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">
            ...
            {/* Section 8 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">8. Data Retention</h2>
              <ul className="list-disc pl-5 sm:pl-6 text-sm sm:text-base text-gray-700 space-y-2 sm:space-y-3 leading-relaxed">
            ...
            {/* Section 9 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">9. Data Security</h2>
              <ul className="list-disc pl-5 sm:pl-6 text-sm sm:text-base text-gray-700 space-y-2 sm:space-y-3 leading-relaxed">
                ...
                <li className="p-3 bg-yellow-50 border-l-4 border-yellow-500 rounded-r list-none text-sm sm:text-base">
            ...
            {/* Section 10 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">10. Your Rights</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3">Subject to applicable laws, you may have the right to:</p>
              <ul className="list-disc pl-5 sm:pl-6 text-sm sm:text-base text-gray-700 space-y-1.5 sm:space-y-2 leading-relaxed">
              ...
              <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-blue-50 border-l-4 border-blue-600 rounded-r">
                <p className="text-gray-700 leading-relaxed text-xs sm:text-sm">
            ...
            {/* Section 11 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">11. Changes to This Privacy Policy</h2>
              <ul className="list-disc pl-5 sm:pl-6 text-sm sm:text-base text-gray-700 space-y-2 sm:space-y-3 leading-relaxed">
            ...
            {/* Section 12 */}
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">12. Contact Us</h2>
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-gray-50 p-4 sm:p-5 md:p-6 rounded-lg border border-gray-200 space-y-1.5 sm:space-y-2">
                ...
                <p className="text-sm sm:text-base"><span className="font-semibold text-gray-700">Email:</span> <a href="mailto:auxopusllp@gmail.com" className="text-blue-600 hover:underline break-all">auxopusllp@gmail.com</a></p>
                <p className="text-sm sm:text-base"><span className="font-semibold text-gray-700">Phone:</span> <a href="tel:+919028194431" className="text-blue-600 hover:underline">+91 9028194431</a></p>
                <p className="text-sm sm:text-base"><span className="font-semibold text-gray-700">Website:</span> <a href="https://www.auxopus.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline break-all">www.auxopus.com</a></p>
                <p className="text-sm sm:text-base"><span className="font-semibold text-gray-700">Address:</span> Plot No 5B, B/H Bright Eng Med School, Mahavir Nagar, Shindkheda, Maharashtra, India</p>
              </div>
            </section>
          </div>
        </div>
