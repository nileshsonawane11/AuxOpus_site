        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-lg leading-8 text-slate-600">
              We create marketing strategies that increase visibility,
              generate quality leads, strengthen your brand, and drive
              measurable business growth across digital platforms.
            </p>
